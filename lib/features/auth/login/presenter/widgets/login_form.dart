...
import '../../../modules.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';  // Importando o flutter_screenutil
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LoginBloc, LoginState>(
      builder: (context, state) {
        return SingleChildScrollView(  // Usando SingleChildScrollView para evitar overflow em telas pequenas
          child: Padding(
            padding: EdgeInsets.symmetric(horizontal: 24.w),  // Usando unidades responsivas
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16.w),  // Responsivo
                      child: Text(
                ...
                OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    padding: EdgeInsets.symmetric(vertical: 16.h),  // Usando altura responsiva
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12.r),  // Usando raio responsivo
                    ),
